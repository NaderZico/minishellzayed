...
/*   Updated: 2025/08/02 13:39:04 by nakhalil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minishell.h"

static int	is_quote_closed(char *str, int in_quote, int in_d_quote, int i)
{
	while (str[i])
	{
		if (str[i] == '\'')
...
static int	check_quotes(char *str)
{
	...
	in_quote = 0;
	in_d_quote = 0;
	if (!is_quote_closed(str, in_quote, in_d_quote, i))
		return (0);
	return (1);
}
